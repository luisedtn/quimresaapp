...
// Encontraremos el bloque buscando `const enrichedData = data.map(cc => {`
// Y lo reemplazaremos todo. Afortunadamente podemos usar expresiones regulares de JS
const oldBlockStart = '// Mapear cantidades desde la f';
const oldBlockEnd = 'console.log(\'Colores de componentes procesados:\', enrichedData);';
const newBlock = `
                  let colorantsSum = 0;
