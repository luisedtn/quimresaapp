...
// But there are text-white occurrences inside bg-[#CC5200] header!
...
c = c.replace(/<h3 className="text-xl font-bold text-slate-900 dark:text-white tracking-tight">Capturando Color...<\/h3>/g, '<h3 className="text-xl font-bold text-white tracking-tight">Capturando Color...</h3>'); // Loading overlay has dark bg regardless
